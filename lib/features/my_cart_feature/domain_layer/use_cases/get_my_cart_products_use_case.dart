...
class GetMyCartProductsUseCase extends BaseUseCase<List<ProductEntity>,void> {
  final BaseCartRepository baseCartRepository;

  GetMyCartProductsUseCase({required this.baseCartRepository});

  @override
  Future<Either<Failure,List<ProductEntity>>> call(object) async {
    return await baseCartRepository.getMyCartProducts();
  }
